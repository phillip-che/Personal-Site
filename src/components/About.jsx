                    ...
                    <div className="about-container">
                        <div className="about-text">
                            <Fade direction="up" delay={300}>
                                ...
                                <p>
                                    Apart from academics, I also run an online sneaker reselling community and business called <a className="effect-shine" href="https://www.solacenotify.com/" target="_blank">Solace Notify</a>. If I'm not coding, I'll probably be playing video games with friends, listening to music, or watching Netflix. 
                                </p>
